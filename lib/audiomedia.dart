...
class AudioMedia extends StatefulWidget {
  ...
  @override
  AudioMediaState createState() => AudioMediaState();
}

class AudioMediaState extends State<AudioMedia> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        _button(Icons.skip_previous, player.seekToPrevious),
